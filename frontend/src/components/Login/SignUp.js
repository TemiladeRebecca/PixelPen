...
function SignUp () {
    ...
    return (
      ...
      <div class="col-lg-6 text-center text-lg-start" style={{marginTop: "0px"}}>
        <h1 class="display-4 lh-1 text-body-emphasis mb-3" style={{ fontFamily: 'Times New Roman, serif' }}>Welcome to PixelPen</h1>
        <p class="col-lg-10 fs-5" style={{fontFamily: 'Helvetica, sans-serif' }}>Capture every idea, accomplish every goal. <span>Start with us Today!</span></p>
      </div>
